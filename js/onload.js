$(document).ready(function()
{
  ...
  $('#go_premium').submit(function(e)
  {
    ...
    $('#premium').val(Math.round(bsm.optionPrice(type) * 100) / 100);
    $('#delta').val(Math.round(bsm.delta(type) * 100) / 100);
    $('#gamma').val(Math.round(bsm.gamma() * 100) / 100);
    $('#theta').val(Math.round(bsm.theta(type) * 100) / 100);
    $('#vega').val(Math.round(bsm.vega() * 100) / 100);
  });
  ...
  $('#go_iv').submit(function(e)
  {
    ...
    var premium = bsm.optionPrice(type);

    $('#iv').val(Math.round(iv * 100) / 100);
    $('#iv_delta').val(Math.round(bsm.delta(type) * 100) / 100);
    $('#iv_gamma').val(Math.round(bsm.gamma() * 100) / 100);
    $('#iv_theta').val(Math.round(bsm.theta(type) * 100) / 100);
    $('#iv_vega').val(Math.round(bsm.vega() * 100) / 100);
